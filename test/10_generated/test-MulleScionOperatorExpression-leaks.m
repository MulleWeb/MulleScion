...
static void test_MulleScionOperatorExpression_noleak(void)
{
   @autoreleasepool
   {
      @try
      {
         [[MulleScionOperatorExpression newWithLineNumber:1] autorelease];
      }
...
int main(int argc, char *argv[])
{
   ...
   test_MulleScionOperatorExpression_noleak();
   return 0;
}