...
static void test_MulleScionExpressionCommand_noleak(void)
{
   @autoreleasepool
   {
      @try
      {
         ...
         [[MulleScionExpressionCommand newWithRetainedExpression:expr lineNumber:1] autorelease];
      }
...
int main(int argc, char *argv[])
{
   ...
   test_MulleScionExpressionCommand_noleak();
   return 0;
}