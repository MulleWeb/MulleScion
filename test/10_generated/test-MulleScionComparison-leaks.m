...
static void test_MulleScionComparison_noleak(void)
{
   @autoreleasepool
   {
      @try
      {
         ...
         MulleScionExpression *right = [MulleScionNumber newWithNumber:@2 lineNumber:1];
         [[MulleScionComparison newWithRetainedLeftExpression:left
                                     retainedRightExpression:right
                                                comparison:MulleScionEqual
...
int main(int argc, char *argv[])
{
   ...
   test_MulleScionComparison_noleak();
   return 0;
}